...
export function DataProvider({ children }: DataProviderProps) {
    const data = [
        ...
        },
        {
            ...
            "extra": "KIR",
            "regCode": "roket_air",
            "description": "Kompetisi Roket Air mengundang siswa SMA/SMK/MA sederajat se-Provinsi Lampung untuk meluncurkan roket air buatan sendiri dari botol 1,5 liter. Setiap tim (maksimal 3 orang) membuat 2 roket dan peluncur, dengan muatan air 200 ml. Penilaian berdasarkan ketepatan pendaratan roket dan desain. Peserta mengenakan seragam olahraga atau KIR sekolah.",
