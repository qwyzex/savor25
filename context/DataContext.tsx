...
export function DataProvider({ children }: DataProviderProps) {
    const data = [
        ...
        },
        {
            ...
            regCode: "kriya",
            description:
                "Kompetisi Kriya mengajak siswa SMP/MTs se-Provinsi Lampung untuk membuat karya seni bertema “Kearifan Lokal dan Pelestarian Budaya Lampung”. Peserta menciptakan karya dari bahan alam seperti kayu atau bambu, disertai video presentasi berdurasi 7 menit. Penilaian berdasarkan orisinalitas, keunikan, estetika, dan kerajinan. Peserta mengenakan seragam sekolah dan boleh mengirimkan lebih dari satu karya per sekolah.",
            form: "https://forms.gle/Py6EzscrbDrfMTuC7",
            booklet:
                "https://drive.google.com/drive/folders/1LldPvcE1xgBw6UGcObNwMvzSm8nbBolh?usp=drive_link",
            edu: "SMP",
            level: 1,
            hue: 110,
            price: 75000,
        ...
        },
        {
            ...
            regCode: "lkbb",
            description:
                "Kompetisi LKBB Variasi Formasi mengundang siswa SMP dan SMA se-Provinsi Lampung untuk menampilkan gerakan baris-berbaris (PBB) dan formasi kreatif. Setiap regu berisi 13-16 orang, tampil selama 10 menit. Penilaian meliputi kekompakan gerakan PBB, kreativitas formasi, dan kepemimpinan ketua regu. Peserta mengenakan seragam sekolah atau OSIS yang sopan. Biaya pendaftaran Rp300.000 per regu, dengan kuota 30 regu.",
            form: "https://forms.gle/cwhD9nBg36mDnG8Q8",
            booklet:
                "https://drive.google.com/drive/folders/16RBiOJd7yFRa6WDvhhL2coYo4jQY0pO2?usp=drive_link",
            edu: "SMP & SMA",
            level: 2,
            hue: 190,
            price: 300000,
        ...
        },
        {
            ...
            description:
                "Kompetisi Miniatur Pioneering Pramuka mengajak siswa SMA se-Provinsi Lampung untuk membuat miniatur struktur menggunakan tali dan kayu dengan teknik Pramuka. Peserta dinilai berdasarkan kreativitas, kekuatan miniatur, dan ketepatan simpul. Kompetisi ini mengasah keterampilan dan kerja sama tim.",
            form: "https://forms.gle/dRJFpACNEAuCAGzg8",
            booklet:
                "https://drive.google.com/drive/folders/1d60YaVCBaWDrcAk8r0CY364vcbtXvn7R?usp=drive_link",
            edu: "SMA",
            level: 0,
            hue: 95,
            price: 65000,
        ...
        },
        {
            ...
            description:
                "Kompetisi Modern Dance mengajak siswa SMP dan SMA se-Provinsi Lampung untuk menampilkan tarian kreatif bertema “Find Your Iconic” yang mencerminkan ciri khas sekolah. Setiap tim beranggotakan 5-10 orang, menari selama maksimal 7 menit dengan gaya bebas seperti hiphop, modern, atau tradisional (kecuali cheerleader). Penilaian berdasarkan kreativitas, kekompakan, kostum, dan kesesuaian tema. Peserta boleh menggunakan properti dengan izin panitia.",
            form: "https://forms.gle/ar9VeRzJ1MJvmpi99",
            booklet:
                "https://drive.google.com/drive/folders/1kAl0pZnJuA-Q2A5lUQf_aJbxCUOLUPyQ?usp=drive_link",
            edu: "SMP & SMA",
            level: 2,
            hue: 270,
            price: 150000,
        ...
        },
        {
            ...
            regCode: "olimpiade",
            description:
                "Kompetisi Olimpiade terbuka untuk siswa SD/MI (IPA dan Matematika) dan SMP/MTs (IPA, Matematika, IPS) se-Provinsi Lampung. Lomba terdiri dari babak penyisihan (pilihan ganda) dan final (isian singkat), masing-masing berdurasi 2 jam. Peserta dinilai berdasarkan kebenaran jawaban dan diharuskan membawa alat tulis serta mengenakan seragam sekolah.",
            form: "https://forms.gle/U1tKAuqyUUsthaZY6",
            booklet:
                "https://drive.google.com/drive/folders/1omOHkE1XM3UbL82rtlFdIO3hyB-Kdn32?usp=drive_link",
            edu: "SD & SMP",
            level: 3,
            hue: 120,
            price: 50000,
        ...
        },
        {
            ...
            description:
                "Kompetisi Pelafalan Doa Hindu mengundang siswa SMP dan SMA se-Provinsi Lampung untuk melafalkan doa Hindu secara individu. Peserta dinilai berdasarkan kejelasan, intonasi, dan penghayatan doa. Peserta wajib mengenakan pakaian adat atau persembahyangan Bali yang sopan. Kompetisi ini menekankan nilai spiritual dan ketepatan pelafalan.",
            form: "https://forms.gle/NvcySkUCti27LwUU7",
            booklet:
                "https://drive.google.com/drive/folders/1OelBxWXuFZwPufBxeEp5E6Pmz0aT_ic6?usp=drive_link",
            edu: "SMP",
            level: 1,
            hue: 305,
            price: 50000,
        ...
        },
        {
            ...
            regCode: "pidato",
            description:
                "Kompetisi Pidato Impromptu mengundang siswa SMP/MTs se-Provinsi Lampung untuk berpidato secara spontan selama maksimal 5 menit. Tema pidato diundi sesuai tema besar SAVOR 2025. Penilaian berdasarkan isi pidato, cara penyampaian, bahasa tubuh, dan penampilan. Peserta mengenakan seragam sekolah dan boleh membawa atribut pendukung yang sopan.",
            form: "https://forms.gle/ZXQUJ1HxfXzNiuXh6",
            booklet:
                "https://drive.google.com/drive/folders/1cBmfuhlMrG4k1BQQdpGN7DY-o2MWVtEl?usp=drive_link",
            edu: "SMP",
            level: 1,
            hue: 25,
            price: 50000,
        ...
        },
        {
            ...
            booklet:
                "https://drive.google.com/drive/folders/1E9asa7B8fnFXOrR5YHfxejqqteSxKh4j?usp=drive_link",
            edu: "SMA",
            level: 0,
            hue: 50,
            price: 75000,
        ...
        },
        {
            ...
            booklet:
                "https://drive.google.com/drive/folders/1bUN4Ji_aggUPzrL8gY4SwTercX5lKMe2?usp=drive_link",
            edu: "SMA",
            level: 0,
            hue: 50,
            price: 75000,
        ...
        },
        {
            ...
            description:
                "Kompetisi Poster Digital mengajak siswa SMA/SMK/MA sederajat se-Provinsi Lampung untuk membuat poster bertema “Bersama Merajut Prestasi, Menggapai Masa Depan”. Poster dibuat secara individu dalam format digital (A3, 300 dpi) dan diunggah di Instagram dengan tagar khusus. Penilaian berdasarkan orisinalitas, kesesuaian tema, estetika, dan penyampaian pesan.",
            form: "https://forms.gle/6jY7t3hWcc9b1V5x7",
            booklet:
                "https://drive.google.com/drive/folders/1gQijmA7waw7a1VG-DzoKb3PHacIUPCvN?usp=drive_link",
            edu: "SMA",
            level: 0,
            hue: 160,
            price: 65000,
        ...
        },
        {
            ...
            regCode: "solo_song",
            description:
                "Kompetisi Solo Song mengajak siswa SMA/SMK/MA sederajat se-Provinsi Lampung untuk menyanyikan satu lagu populer dari daftar pilihan, seperti karya Raisa atau Judika. Penilaian berdasarkan teknik vokal, improvisasi, penghayatan, serta ekspresi panggung. Peserta mengenakan pakaian bebas yang sopan dan rapi. Setiap sekolah boleh mengirimkan maksimal 3 peserta.",
            form: "https://forms.gle/nY9WzyWD5o1s54cu7",
            booklet:
                "https://drive.google.com/drive/folders/1VYg46UXL6SJ-vZ8NlZkljPggY42XEJYW?usp=drive_link",
            edu: "SMA",
            level: 0,
            hue: 0,
            price: 75000,
